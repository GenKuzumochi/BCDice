    ...
    class GranCrest < Base
      ...
      def result_nd6(total, _dice_total, dice_list, cmp_op, target)
        ...
        if dice_list.count(6) >= 2
          total += 10
          result_text << "（#{translate('critical')}）" << total.to_s
        ...
        if cmp_op == :>= && target != '?'
          if total >= target
            result.success = true
            result_text << translate("success")
          else
            result.failure = true
            result_text << translate("failure")
          end
        end
        result.text = result_text.join(" ＞ ") unless result_text.empty?
        result
      end
      ...
      TABLES = {
        ...
        "PFT" => DiceTable::D66GridTable.new(
          "ポジティブ感情表",
          [[
        ...
        "NFT" => DiceTable::D66GridTable.new(
          "ネガティブ感情表",
          [[
        ...
        "CT" => DiceTable::Table.new("国特徴・カテゴリー表", "1d6", [
        ...
        "TCT" => DiceTable::D66GridTable.new(
          "国特徴・地形表",
          [[
        ...
        "ICT" => DiceTable::D66GridTable.new(
          "国特徴・産業表",
          [[
        ...
        "PCT" => DiceTable::D66GridTable.new(
          "国特徴・人物表",
          [[
        ...
        "OCT" => DiceTable::D66GridTable.new(
          "国特徴・組織表",
          [[
        ...
        "BCT" => DiceTable::D66GridTable.new(
          "国特徴・拠点表",
          [[
        ...
        "CCT" => DiceTable::D66GridTable.new(
          "国特徴・文化表",
          [[
